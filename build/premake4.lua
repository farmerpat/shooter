...
solution "shooter"
    ...
    configuration {"macosx"}
        includedirs {"/Users/patrickconnelly/sources/orx/code/include"}
        libdirs {"/Users/patrickconnelly/sources/orx/code/lib/dynamic"}
...
-- Mac OS X
    ...
    configuration {"macosx"}
        postbuildcommands {"cp -f /Users/patrickconnelly/sources/orx/code/lib/dynamic/liborx*.dylib " .. copybase .. "/bin"}
